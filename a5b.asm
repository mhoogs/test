...
define(argc_r, w19) //number of arguments represented with w19 register 
define(argv_r, x20) //array of pointers to the arguments represented with x20 register 
...
main: 
	...
	mov argc_r, w0 //number of arguments moved onto register w0
	mov argv_r, x1 //array of pointers to the arguments moved onto register x1
	
	cmp argc_r, 3 //check if number of arguments is 3
...
check_month: 
	...
	ldr x0, [argv_r, w19, SXTW 3] //load second argument onto w0 register
...
feb_test:
	...
	ldr x0, [argv_r, w19, SXTW 3] //get day 
...
check_31: //checks if date exists in months with 31 days, and checks the exception months 
	...
	ldr x0, [argv_r, w19, SXTW 3] //load third argument onto x0 register
	bl atoi //convert ASCII string to integer and load result onto w0 register
	mov w25, w0 //move int result onto w25 register 
...
check_30:
	...
	ldr x0, [argv_r, w19, SXTW 3] //load x0 with the second argument (day)

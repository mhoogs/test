...
equal:	
	...
	define(result, w23) //setting macro for result 
	...
	mov result, true //if heights are equal, result = true 
...
//	print initial box values 
	...
	cmp result, true //check if result == true

	b.ne changed_print //if result == false branch to changed_print to print changed box values

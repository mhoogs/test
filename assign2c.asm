...
main: //main function
        ...
        mov multiplicand_r, -252645136 //setting the multiplicand to integer -16843010
        mov multiplier_r, -256 //setting the multiplier to integer 70
...
test: cmp i_r, 32 //compare it to integer 32
	...
	b check_negative_2 //branch to check_negative_2
